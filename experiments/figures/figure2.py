...
# Path to baseline experiment results
RESULTS_DIR = Path("experiments/results/figure2-baseline_2026-01-15_21-33-14")
...
def main():
    ...
    # Add vertical lines at burn-in boundaries
    ax1.axvline(x=100, color='#9b59b6', linestyle=':', linewidth=2, alpha=0.7, label='Burn-in Start')
    ax1.axvline(x=200, color='#9b59b6', linestyle=':', linewidth=2, alpha=0.7, label='Burn-in End')
    ...
    # EMA parameters (from adversarial burn-in config)
    burn_in = 100
    ...
    # Overall title
    fig.suptitle('Figure 2: Control Chart Methods for Isomirror Monitoring', fontsize=14, fontweight='bold')
    plt.tight_layout()
